...
const ImmersiveSection = () => {
  return (
    <section className="relative overflow-hidden bg-[#fff8f3] px-6 py-32 text-center">
      <div className="absolute left-1/4 top-20 h-48 w-48 rounded-full bg-pink-200/40 blur-3xl" />
      <div className="absolute right-1/4 bottom-20 h-56 w-56 rounded-full bg-green-100/50 blur-3xl" />
      ...
      <div className="relative z-10 mx-auto max-w-5xl rounded-[3rem] border border-[#f1ddd7] bg-white/60 px-8 py-24 shadow-xl backdrop-blur-xl">
